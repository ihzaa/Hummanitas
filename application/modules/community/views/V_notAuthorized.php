                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?= base_url('assets/'); ?>app-assets/images/pages/lock.png" style="heigth: 200px;width:200px;" class="img-fluid align-self-center" alt="branding logo">
                                    <h1 class="font-large-2 my-2">Access denied!</h1>
                                    <p class="p-2">
                                        the page may only be visible to an audience you're not in.
                                    </p>
                                    <a class="btn btn-primary btn-lg mt-2" href="<?= base_url('user') ?>">Back to Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
