                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4 col-6 user-latest-img">
                                                <a href="app-assets/images/profile/user-uploads/user-01.jpg" data-lightbox="mygallery"><img src="app-assets/images/profile/user-uploads/user-01.jpg" class="img-fluid mb-1 rounded-sm" alt="avtar img holder"></a>
                                            </div>
                                            <div class="col-md-4 col-6 user-latest-img">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-center">
                                                <a type="button" href="gallery-album(member).html" class="btn btn-primary block-element mb-1">+ View More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
