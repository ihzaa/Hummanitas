                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="card" style="min-height: 500px">
                                    <div class="card-header">
                                        <?php $gallery =  $this->db->get_where('gallery', ['GALLERY_ID' => $this->uri->segment(5)])->row_array();
                                        $name = $gallery['GALLERY_NAME']; ?>
                                        <nav aria-label="breadcrumb">
                                            <nav aria-label="breadcrumb">
                                                <ol class="breadcrumb" style="font-size: 20px;">
                                                    <li class="breadcrumb-item"><a href="<?= base_url('community/' . $community['COM_ID'] . '/guest/gallery'); ?>">Gallery</a></li>
