                        ...
                        <div class="card bg-authentication rounded-0 mb-0 w-100">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center p-0">
                                    <img src="<?= base_url('assets/'); ?>app-assets/images/pages/reset-password.png" alt="branding logo">
                                </div>
                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form method="post" action="<?= base_url('auth/changePass') ?>">
                                                    <fieldset class="form-label-group">
                                                        <input type="text" class="form-control" id="user-email" readonly value="<?= $this->session->userdata('reset_email'); ?>" placeholder="Email" required>
                                                    ...
                                                    <fieldset class="form-label-group">
                                                        <input type="password" class="form-control" name="confirm_pass" id="user-confirm-password" placeholder="Confirm Password" required>
                                                        <label for="user-confirm-password">Confirm Password</label>
                                                    </fieldset>
                                                    <div class="row pt-2">

                                                        <div class="col-12 col-md-6 mb-1">
                                                            <button style="width: 220%" type="submit" class="btn btn-primary btn-block px-0">Reset Password</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
