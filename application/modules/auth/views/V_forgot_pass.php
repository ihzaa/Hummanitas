                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center">
                                    <img src="<?= base_url('assets/'); ?>app-assets/images/pages/forgot-password.png" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2 py-1">
                                        ...
                                        <p class="px-2 mb-0">Please enter your email address to reset your password.</p>
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form method="post" action="<?= base_url('auth/forgotPass') ?>">
                                                    ...
                                                    <div class="float-md-left d-block mb-1">
                                                        <a href="<?= base_url('auth'); ?>" class="btn btn-outline-primary btn-block px-75">Back to
                                                            Login</a>
                                                    </div>
