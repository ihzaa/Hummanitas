                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Welcome to Hummanitas.</p>
                                            ...
                                            <div class="card-body pt-1">
                                                ...
                                                <form action="<?php echo base_url('auth'); ?>" method="post">
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control" name="username" id="user-name" placeholder="Username" value="<?= set_value('username') ?>" required>
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        <div class="text-left"><a href="<?php echo base_url('auth/forgotPass') ?>" class="card-link">Forgot Password?</a></div>
                                                    </div>
                                                    <a href="<?php echo base_url('auth/register') ?>" class="btn btn-outline-primary float-left btn-inline">Register</a>
