...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
                        ...
                        <ul class="nav navbar-nav flex-row ">
                            <li class="nav-item ">
                                <a class="navbar-brand" href="<?= base_url('auth') ?>">
                                    ...
                                    <h2 class="d-inline-block" style="color:#7367f0; font-weight: 600;font-size: 50px;">
                                        Hummanitas</h2>
                                </a>
                            </li>
                        </ul>
    ...
    <!-- BEGIN: Content-->
    <div class="app-content content" style="padding-top: 7rem;">
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 id="basic-forms" class="card-title"> WELCOME TO HUMMANITAS </h4>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-7">
                                <h4 id="basic-forms" class="card-title">ABOUT </h4>
                                <p class="card-text"></p>
                                ...
                                <p class="card-text"> Hummanitas is a website to make it easier for people to form communities on social networks. In this website we present the main features that can form partnerships with other communities or control finances in your community, in addition there are also event features that help your community in forming events ... Our website also provides a gallery where you can save photos of the results your community documentation.</p>
                                <p> </p>
                                <p> </p>
                            </div>
                            <div class="col">
